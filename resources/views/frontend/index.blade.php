                                ...
                                <li class="yamm-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <h2 class="title"> @if(session()->get('language') == 'bangla') {{ $subcategory->sub_category_name_bn }} @else {{ $subcategory->sub_category_name_en }} @endif </h2>
                                            @php
                                                $subsubcategories = \App\Models\SubSubCategory::where('subcategory_id',$subcategory->id)->orderBy('subsubcategory_name_en','ASC')->get();
                                            @endphp
                                        <ul class="links list-unstyled">
                                            @foreach($subsubcategories as $subsub)
                                                <li><a href="#"> @if(session()->get('language') == 'bangla') {{ $subsub->subsubcategory_name_bn }} @else {{ $subsub->subsubcategory_name_en }} @endif  </a></li>
                                            @endforeach
                                            </ul>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        @if ($product->discount_price == NULL)
                                            <div class="sale-offer-tag"><span>New <br> off</span></div>
                                        @else
                                ...
                                <div class="product">
                                    <div class="product-micro">
                                        <div class="row product-micro-row">
                                            <div class="col col-xs-5">
                                                <div class="product-image">
                                                    <div class="image"> <a href="#"> <img src="{{ asset('frontend/assets/images/products/p17.jp') }}g" alt=""> </a> </div>
                                                    <!-- /.image -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
            ...
            <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                ...
                <div class="tab-content outer-top-xs">
                    <div class="tab-pane in active" id="all">
                        <div class="product-slider">
                            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                ...
                                @endforeach {{--all product option End here--}}
                                <!-- /.item -->
                    ...
                    {{--Dynamic Category wise product loaded--}}
                    ...
                    <div class="tab-pane" id="category{{ $category->id }}">
                        <div class="product-slider">
                            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                ...
                                @endforelse {{--all product option End here--}}
                                <!-- /.item -->
            ...
            {{-- Skip Category show product Start--}}
            ...
            {{-- Skip Category show product End--}}

            {{-- Skip Brand show product Start--}}
